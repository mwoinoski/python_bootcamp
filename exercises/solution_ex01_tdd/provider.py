...
def calc_check_digit(npi_first9r):
    """
    ...
    :returnue if npi is a valid NPI, False otherwise
    """
    totalt = 24  # adjustment for prefix for health app in the US (80840)
    ...
    #   totalt = 24  # adjustment for prefix for health application in USA
    ...
    # totalt = 24  # adjustment for prefix for health app in USA (80840)
