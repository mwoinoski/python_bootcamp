...
class Patient(Person):
    ...
    def __init__(self, database_id: Optional[str] = None, family: Optional[str] = None, given: Optional[str] = None,
                 middle: Optional[str] = None, timestamp: Optional[datetime] = None) -> None:
        super().__init__(patient_id, family, given, middle, timestamp)
