...
from process_csv_files import (facilities_with_max_value_hard_to_test, read_csv_stream, facilities_with_max_value_by_column_index,
                               facilities_with_max_value_from_stream, facilities_with_max_value)


def test_read_csv_stream_success():
    csv_text = '''\
    ...
    header, result = read_csv_stream(csv_input_stream)
